...
import {
    Ticket, CreditCard, Plus, ArrowRight, ArrowLeft, Save, User,
    Phone, MapPin, Mail, FileText, CheckCircle, Calendar, Clock,
    Users, Dumbbell, Tag, CalendarDays, Gift, ShoppingBag, UserCheck
} from 'lucide-react';
...
export default function PassesPage() {
    ...
    const handleCreatePackage = async () => {
        ...
        const newPackage = {
            ...
            duration: durationMode === 'unlimited' ? 365 : 30, // Simplified duration logic
            features: selectedBenefits.join(',')
        };

        try {
            const apiUrl = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:5001';
            const response = await fetch(`${apiUrl}/api/passes`, {
                method: 'POST',
    ...
    if (viewMode === 'ONETIME_FORM') {
        return (
            <div className="max-w-4xl mx-auto mt-6 animate-fadeIn">
                ...
                <div className="bg-[#161b22] rounded-2xl shadow-xl border border-slate-800 overflow-hidden">
                    <div className="p-6 border-b border-slate-800 bg-slate-900/30 flex justify-between items-center">
                        <div>
                            <h2 className="text-xl font-bold text-white">ერთჯერადი ვიზიტის გაცემა</h2>
                        ...
                        <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input type="text" className="w-full px-4 py-2.5 rounded-lg border border-slate-700 bg-[#0d1117] text-white focus:border-lime-500 focus:ring-1 focus:ring-lime-500 outline-none transition-all font-medium" placeholder="მაგ: დავით ბერიძე" />
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input type="tel" className="w-full px-4 py-2.5 rounded-lg border border-slate-700 bg-[#0d1117] text-white focus:border-lime-500 focus:ring-1 focus:ring-lime-500 outline-none transition-all font-medium" placeholder="555 00 00 00" />
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input type="text" className="w-full px-4 py-2.5 rounded-lg border border-slate-700 bg-[#0d1117] text-white focus:border-lime-500 focus:ring-1 focus:ring-lime-500 outline-none transition-all font-medium" placeholder="01000000000" />
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <input type="email" className="w-full px-4 py-2.5 rounded-lg border border-slate-700 bg-[#0d1117] text-white focus:border-lime-500 focus:ring-1 focus:ring-lime-500 outline-none transition-all font-medium" placeholder="email@example.com" />
                                </div>
                                ...
                                <div className="col-span-1 md:col-span-2 space-y-2">
                                    ...
                                    <input type="text" className="w-full px-4 py-2.5 rounded-lg border border-slate-700 bg-[#0d1117] text-white focus:border-lime-500 focus:ring-1 focus:ring-lime-500 outline-none transition-all font-medium" placeholder="თბილისი, ჭავჭავაძის გამზ..." />
                                </div>
                            </div>
                            ...
                            <div className="space-y-8">
                                <h3 className="text-sm font-bold uppercase tracking-wider text-slate-500">ვიზიტის დეტალები</h3>

                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                                    <div className="space-y-6">
                                        <div className="space-y-2">
                                            <label className="text-sm font-medium text-slate-400">ვიზიტის ტიპი / აქტივობა</label>
                                        ...
                                        <div className="space-y-2">
                                            <label className="text-sm font-medium text-slate-400">გადასახდელი თანხა</label>
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className={`w-full pl-8 pr-4 py-3 rounded-lg border outline-none transition-all font-bold text-lg ${isGuest
                                                        ...
                                                        : 'bg-[#0d1117] border-slate-700 focus:border-lime-500 focus:ring-1 focus:ring-lime-500 text-white'
                                                        }`}
                                                />
                                            </div>
                                        </div>
                            ...
                            <div className="flex justify-end pt-6 space-x-3">
                                ...
                                <button
                                    ...
                                    className="flex items-center space-x-2 px-8 py-3 bg-lime-500 hover:bg-lime-600 text-slate-900 font-bold rounded-xl shadow-lg shadow-lime-500/20 transition-all active:scale-95"
                                >
                                    <Save size={18} />
            ...
            <div className="max-w-5xl mx-auto mt-6 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 space-y-6">
                        <div className="bg-[#161b22] rounded-2xl shadow-xl border border-slate-800 overflow-hidden p-8">
                            <div className="flex items-center space-x-3 mb-6 border-b border-slate-800 pb-4">
                                <div className="w-10 h-10 bg-emerald-500/10 rounded-lg flex items-center justify-center text-emerald-500">
                                    <CreditCard size={20} />
                                </div>
                                <h2 className="text-xl font-bold text-white">ახალი აქტივობის შექმნა</h2>
                            </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-3">
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-3 rounded-lg border border-slate-700 bg-[#0d1117] text-white focus:border-lime-500 focus:ring-1 focus:ring-lime-500 outline-none transition-all font-medium"
                                        />
                                        <p className="text-xs text-slate-500">მიუთითეთ რამდენი ადამიანისთვისაა პაკეტი</p>
                                    </div>
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-[#161b22] rounded-2xl shadow-xl border border-slate-800 p-6 sticky top-6">
                            <h3 className="text-lg font-bold text-white mb-6">7. ღირებულება</h3>
                            ...
                            <div className="space-y-4 mb-8">
                                ...
                                <div className="p-4 bg-slate-900/50 rounded-xl space-y-2 border border-slate-800">
                            ...
                            <div className="space-y-3">
                                <button
                                    ...
                                    disabled={loading}
                                    className="w-full py-4 bg-lime-500 hover:bg-lime-600 text-slate-900 font-bold rounded-xl shadow-lg shadow-lime-500/20 transition-all active:scale-95 flex items-center justify-center space-x-2 disabled:opacity-50"
                                >
                                    <Save size={20} />
                                    <span>{loading ? 'Creating...' : 'აქტივობის შექმნა'}</span>
                                </button>
                                <button
                                    onClick={() => setViewMode('MENU')}
                                    className="w-full py-3 text-slate-500 hover:text-white hover:bg-slate-800 font-medium rounded-xl transition-all"
                                >
                                    გაუქმება
                                </button>
                            </div>
        ...
        <div className="max-w-5xl mx-auto mt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                ...
                <button
                    ...
                    className="group relative bg-[#161b22] p-8 rounded-3xl shadow-lg border border-slate-800 hover:border-lime-500/50 transition-all duration-300 text-left overflow-hidden"
                >
                    <div className="absolute -right-6 -top-6 w-32 h-32 bg-lime-500/10 rounded-full group-hover:scale-150 transition-transform duration-500 ease-out z-0"></div>
                    <div className="absolute right-8 top-8 opacity-10 group-hover:opacity-20 transition-opacity z-0">
                        <Ticket size={100} className="text-lime-500" />
                    </div>

                    <div className="relative z-10">
                        <div className="w-16 h-16 bg-[#0d1117] shadow-md rounded-2xl flex items-center justify-center text-lime-500 mb-6 group-hover:scale-110 transition-transform duration-300 border border-slate-800">
                            <Ticket size={32} />
                        </div>

                        <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-lime-400 transition-colors">ერთჯერადი ვიზიტი</h3>
                        <p className="text-slate-500 text-sm leading-relaxed mb-8 max-w-xs">
                            სწრაფი საშვის გენერირება დღიური ვიზიტორებისთვის. QR კოდის ან დროებითი ID-ის გაცემა.
                        </p>

                        <div className="flex items-center text-lime-500 font-bold text-sm bg-lime-500/10 w-fit px-4 py-2 rounded-lg group-hover:bg-lime-500 group-hover:text-slate-900 transition-all">
                ...
                <button
                    ...
                    className="group relative bg-[#161b22] p-8 rounded-3xl shadow-lg border border-slate-800 hover:border-emerald-500/50 transition-all duration-300 text-left overflow-hidden"
                >
                    <div className="absolute -right-6 -top-6 w-32 h-32 bg-emerald-500/10 rounded-full group-hover:scale-150 transition-transform duration-500 ease-out z-0"></div>
                    <div className="absolute right-8 top-8 opacity-10 group-hover:opacity-20 transition-opacity z-0">
                        <CreditCard size={100} className="text-emerald-500" />
                    </div>

                    <div className="relative z-10">
                        <div className="w-16 h-16 bg-[#0d1117] shadow-md rounded-2xl flex items-center justify-center text-emerald-500 mb-6 group-hover:scale-110 transition-transform duration-300 border border-slate-800">
                            <CreditCard size={32} />
                        </div>

                        <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-emerald-400 transition-colors">აქტივობის შექმნა</h3>
                        <p className="text-slate-500 text-sm leading-relaxed mb-8 max-w-xs">
                            ახალი აბონემენტის რეგისტრაცია, პაკეტის არჩევა და მომხმარებელზე მიბმა.
                        </p>

                        <div className="flex items-center text-emerald-500 font-bold text-sm bg-emerald-500/10 w-fit px-4 py-2 rounded-lg group-hover:bg-emerald-500 group-hover:text-white transition-all">
