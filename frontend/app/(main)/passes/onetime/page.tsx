    ...
    return (
        <div className="flex-1 bg-slate-50 relative overflow-hidden flex flex-col items-center justify-center p-8">
            <div className="bg-white p-12 rounded-[3rem] shadow-xl border border-slate-100 flex flex-col items-center text-center max-w-md w-full animate-fadeIn">
                <div className="w-20 h-20 bg-emerald-100 rounded-3xl flex items-center justify-center mb-6 text-emerald-600 shadow-lg shadow-emerald-100">
                    <Ticket size={40} />
                </div>
                <h1 className="text-2xl font-black text-slate-800 mb-2">ერთჯერადი ვიზიტები</h1>
                <p className="text-slate-500 font-medium mb-8 leading-relaxed">
                    ეს გვერდი დამუშავების პროცესშია. მალე შეძლებთ ერთჯერადი ვიზიტების მართვას.
                </p>
